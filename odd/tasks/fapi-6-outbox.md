...
- [ ] T11 Re-review MAJOR 1: bounded resubmission (load only the selected batch)
- [ ] T12 Re-review minors: exact deserialization exception, cross-instance double-attempt sentence; full check
