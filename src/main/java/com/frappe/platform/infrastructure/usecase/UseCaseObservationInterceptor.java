...
final class UseCaseObservationInterceptor implements MethodInterceptor {
    ...
    // One description per use case class, computed on first call; ClassValue is the JDK's per-class cache.
    private static final ClassValue<UseCase> USE_CASES = new ClassValue<>() {
        @Override
    ...
    public @Nullable Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        var context = new UseCaseObservationContext(USE_CASES.get(useCaseClass));
