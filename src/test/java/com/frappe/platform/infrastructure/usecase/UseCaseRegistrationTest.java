...
import fixtures.usecases.application.ValidUseCases;
...
class UseCaseRegistrationTest {
    ...
    @AutoConfigurationPackage(basePackageClasses = ValidUseCases.class)
    ...
    void useCasesInTheApplicationPackagesAreBeans() {
        new ApplicationContextRunner()
                ...
                .run(context -> {
                    assertThat(context).hasSingleBean(ValidUseCases.OpenTab.class);
                    assertThat(context).hasSingleBean(ValidUseCases.FindTab.class);
                    assertThat(context).hasSingleBean(ValidUseCases.RecordFailedLogin.class);
                });
    }
}
