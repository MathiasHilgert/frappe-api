...
func Validate(configuration Configuration) error {
	...
	crossFieldViolations = append(crossFieldViolations, validateCursorSecret(configuration.Application, configuration.HTTP)...)
	...
	crossFieldViolations = append(crossFieldViolations, validateDeepL(configuration.DeepL)...)
